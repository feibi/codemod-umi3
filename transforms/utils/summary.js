...
const summaryFilePath = path.join(require('os').tmpdir(), './antd4-codemod-summary.csv');
...
async function appendLine(fileName, source, message) {
  ...
  return await fsAppendFileAsync(summaryFilePath, lineContent, encoding, Function.prototype);
}
